...
install:
	...
	cd gfxstream/;meson install -C build;cd /usr/local/lib/x86_64-linux-gnu/;rm librutabaga_gfx_ffi.so;rm librutabaga_gfx_ffi.so.0;ln -sf librutabaga_gfx_ffi.so.0.1.3 librutabaga_gfx_ffi.so.0;ln -sf librutabaga_gfx_ffi.so.0.1.3 librutabaga_gfx_ffi.so;ln -sf cd ..
